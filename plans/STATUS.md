...
4. **Meta Ads Jerusalem test — bucket 8 in active Canva production; still not launched.** `marketing/plans/META_ADS_PLAN.md` has the full candidate library (12 buckets + fresh-eyes pool) plus a detailed shot list for bucket 8 ("Calendar of confidence," the user's favorite, not formally locked). Real assets found and being assembled: a delivery-clip source, a calendar background, a finalized 7-icon set. Next: finish assembling in Canva, then Prerequisites #1 (Round 1 specifics) before anything runs.
