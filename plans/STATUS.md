...
**Updated:** 2026-05-18 (mobile LCP rollback v1.2.26+v1.2.27 + small-CSS sweep v1.2.28 — LCP 4.0 now BELOW baseline 4.1, FCP 3.5 within PSI noise; magnums fully retired template+term+WPML; Content Library plan 2026-05-18 refinement committed `f59d23e` — slug conventions, sibling-language reshape, image-as-entity, MD-local revision, template channel-language split, KPI ingest pattern, Drive folder structure; next LCP lever is render-blocking pile — main.css critical-CSS + jQuery defer, separate plan)
