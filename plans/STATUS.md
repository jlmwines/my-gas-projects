...
**Updated:** 2026-05-17 (mobile LCP work shipped theme v1.2.24 + v1.2.25 — hero preload + WebP picture + logo deprio + block-CSS dequeue tighten + elementor prefetch strip — BUT REGRESSED mobile FCP 3.2→3.6 and LCP 4.1→4.3 vs cutover-week baseline; rollback queued for next session; Content Library plan written `plans/CONTENT_LIBRARY_PLAN.md` after architectural reflection — entity-references model unifying CRM/Campaigns/Publishing/Content under one library; lookup-add UI bug added; Magnums removal confirmed still pending)
...
| Revenue | Steady |
| Deploy Version | jlmops @119 · theme v1.2.25 LIVE (uncommitted; mobile LCP work regressed metrics, rollback queued) |
| Deploy Date | jlmops 2026-05-15 (@117 → @119) · theme 2026-05-17 (v1.2.24 + v1.2.25 mobile LCP — REGRESSED) |
...
| Blockers | 0 |
| Mobile PageSpeed (post-cutover) | Baseline 2026-05-05: EN FCP 3.2 / LCP 4.1 · HE FCP 3.5 / LCP 4.0 · TBT 210ms. After 2026-05-17 LCP work (v1.2.24+v1.2.25): single-run mobile FCP 3.6 / LCP 4.3 — REGRESSED. Rollback queued for next session. |
