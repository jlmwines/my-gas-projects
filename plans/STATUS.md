...
**Updated:** 2026-08-06. jlmops @544 live, stable, unchanged since the 2026-07-26 WebXltM incident fix (see `.claude/bugs.md` for that history). Marketing-side: Meta Ads Jerusalem test launched 2026-08-06 — 3 reels (bucket 8 Calendar, bucket 14 Reviews, bucket 7 new) as 3 separate ads in one ad set, ₪550 through end of August, Sun–Thu. July print newsletter distribution confirmed today. Flyer Round 1 (Talbiye) redemptions still too soon to read; Round 2 (Emek Refaim) targeted 3rd week of August.
...
- **marketing** — flyer active (Round 1 pending, Round 2 planned); Meta Ads Jerusalem test live (3 reels, ₪550/Sun-Thu through end of August), results pending; newsletter cadence current.
...
4. **Meta Ads Jerusalem test — round 1 launched 2026-08-06.** 3 reels (bucket 8 "Calendar of confidence," bucket 14 real Google reviews, bucket 7 new) as 3 separate ads in one ad set (not a single pooled Dynamic Creative ad as originally planned 2026-08-04 — see `marketing/plans/META_ADS_PLAN.md` Round Log for why). ₪550 budget through end of August, Sun–Thu only. UTM-tagged per-ad URLs confirmed, CTA Shop Now, optimization on web traffic (no Pixel). Next: confirm background music made it into the uploaded files, then let the round run its minimum duration before reading results (Confirmation checklist).
