...
**Updated:** 2026-05-18 (mobile LCP rollback v1.2.26+v1.2.27 + small-CSS sweep v1.2.28 — LCP 4.0 now BELOW baseline 4.1, FCP 3.5 within PSI noise; magnums fully retired template+term+WPML; Content Library plan 2026-05-18 refinement committed `f59d23e`; Context post drafted EN+HE to WP live drafts 67403/67405 with 4 Canva-generated body images uploaded to live media library (IDs 67407-67410) — `tools/wp-api.js` extended with `uploadMedia()`, `.wp-credentials` retargeted to live; next LCP lever is render-blocking pile — main.css critical-CSS + jQuery defer, separate plan)
...
| Content | 9 editorial posts live on production (EN+HE); Context EN+HE drafted on live 2026-05-18 (drafts 67403/67405, 4 body images uploaded as media 67407-67410, awaiting user review — see Other in-flight initiatives); 4 in pipeline (A Year in the Vineyard under review/translation; Handling and Storage, Reds Guide, Whites Guide awaiting editing + translation) |
...
- **Newsletter v1** — printed monthly insert (online + store handout). Layout + format finalized 2026-05-08 (`marketing/NEWSLETTER_PLAN.md` — A4 b/w, two-col, masthead "Wine Talk — from Evyatar," signup CTA copy lifted from live footer, QR 3cm/EC-Q, secondary slot rotates YiV / 2nd post / Did You Know). Print Newsletter Body now a required post-source section per `content/CLAUDE.md`; template at `content/_post-template.md`. **2026-05-18: Context lead drafted to live WP** — EN + HE bodies pushed to drafts 67403/67405 with 4 Canva-generated impressionist body images (uploaded as WP media 67407-67410). User to review drafts next session; remaining: A4 Canva newsletter design (EN + HE), and Mailchimp companion campaign (separate send) carrying redesign mention. Print stays editorial.
