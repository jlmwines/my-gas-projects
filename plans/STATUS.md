...
9. **Local file/folder cleanup** (`plans/FILE_CLEANUP_PLAN.md`) — executed 2026-07-10, all 6 categories. `jlmops/exchange/` fully cleared; root `exchange/` down from ~130 to ~19 items. A few ambiguous files (a Mailchimp credential, a jlmops UI design-system preview, two theme-zip candidates, loose `.po` translation files) were deliberately left for a decision — see plan doc "Remaining decision items."
