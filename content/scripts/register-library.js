...
//
// Usage:
//   node content/scripts/register-library.js                          # list manifest + registration status
//   node content/scripts/register-library.js <slug>                   # register one entry
//   node content/scripts/register-library.js --all                    # register all unregistered
//   node content/scripts/register-library.js --update <slug>          # patch existing row's email metadata
//   node content/scripts/register-library.js --update --all           # patch all manifest entries that already exist
//
...
יין ירושלים`,
  ...
  // 2026-06-25: new doc created with full template (TITLE/EXCERPT/NEWSLETTER/PRINT/CTA/IMAGE PROMPTS/body).
  {
    ...
    md_file: 'regions/negev/negev-en.post.md',
  ...
  // HE sibling not created yet (added at the translate stage).
  {
    ...
    md_file: 'regions/galilee/galilee-en.post.md',
