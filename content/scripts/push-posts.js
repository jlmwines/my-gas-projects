...
//
// Usage:
//   node content/scripts/push-posts.js                  # list all posts
//   node content/scripts/push-posts.js pairing          # push EN post
//   node content/scripts/push-posts.js pairing --he     # push HE post
//   node content/scripts/push-posts.js --all            # push all EN
//   node content/scripts/push-posts.js --all --he       # push all HE
//   node content/scripts/push-posts.js --all --both     # push all EN + HE
// ═══════════════════════════════════════════════════════════════════
...
function listPosts() {
  ...
  console.log('\nUsage:');
  console.log('  node content/scripts/push-posts.js <name>           # push EN');
  console.log('  node content/scripts/push-posts.js <name> --he      # push HE');
  console.log('  node content/scripts/push-posts.js --all            # push all EN');
  console.log('  node content/scripts/push-posts.js --all --he       # push all HE');
  console.log('  node content/scripts/push-posts.js --all --both     # push all EN + HE');
}
