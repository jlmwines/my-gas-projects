...
**Central Mountains** — Opening archetype: quality-heartland / mixed (lead with Judean Hills). Composite region per IPEVO's own sub-region list: **Mt. Gilboa** (corrected 2026-07-09 — this note previously said "Mt. Carmel," which is a different range entirely, already used for the Coastal Plain post; the guide plan's sub-region table and the Montefiore PDF both say Gilboa) + Shomron Hills (planted mostly 2000s onward; Gvaot, Tura — not independently verified against Montefiore, confirm before publishing) + Judean Hills (Jerusalem corridor, 400–1,000m, thin terra rossa; Castel 1992, Tzora 1993). Tribal: Ephraim + western Manasseh (Shomron); Benjamin/Judah around Jerusalem. **Extended pass rebuilt and superseded live in the library, 2026-08-27** — manager edited Title + Body directly in the Drive doc since the 2026-07-09 draft (retitled, watershed-divide paragraph added, elevation anecdote 1,000m→800m, geographic extent widened to the Hebron mountains/northern Negev, one paragraph dropped); session pulled the edited body verbatim and rebuilt Excerpt through Image Prompts from it in `content/regions/central-mountains/central-mountains-en.post.md` (length-checked against template targets — Body 843w, Excerpt 136ch, Email Preview 150ch, Newsletter Excerpt 52w, Print Body 160w — all in range), matched the mature-post Doc shape (full Title-through-Notes) confirmed against the live Negev/Galilee library Docs, and placed a new versioned Doc at the canonical path. Admin attached it via the live app same day — `blog-region-central-mountains-en`'s `slb_DocUrl` now points to the new Doc; the prior Doc is marked "Superseded by →" and archived.
