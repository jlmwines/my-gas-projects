...
**Doorbell-cam asset, build note (2026-07-30, decided — stills, not video).** Checked Canva's stock video for "package delivery"/"package door" — nothing suitable; stills route confirmed instead. No real doorbell app or device used or needed. Build: a staged photo of a package at a door (any regular phone camera), circular/fisheye crop for the "doorbell cam" look — safer than a notification-banner route against the Meta system-UI-mimicry risk flagged above, since nothing simulates an actual OS/app element, just a photographic framing choice. **No identifiable faces (no courier in frame) and no identifiable address/house number.**
