...
**Almost-resolving logo tease (2026-07-30):** whichever route is used, the package can show a partial, not-quite-clear glimpse of JLM's orange color/logo — enough to plant brand recognition and curiosity, cut away right before it would fully read. Works with either visual route above; the tease resolves properly later (the loop-back or the "order wine" beat), giving that later moment more payoff than if the logo were already clear at the open.
