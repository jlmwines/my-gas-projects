...
- At the start of every new session for the jlmops project, my first action MUST be to silently read the latest versions of `ARCHITECTURE.md`, `IMPLEMENTATION_PLAN.md`, `WORKFLOWS.md`, and `DATA_MODEL.md`. After silently reading, I must await the user's next instruction.
