...
*   **Columns:**
    ...
    *   `cal_Link`: Optional plain URL, informational only — the Calendar tab (`PublishingView.html`) displays it as plain text next to the title (not clickable, fixed 2026-07-08; an earlier version rendered it as a click-out icon to the live URL, judged not useful in practice).
