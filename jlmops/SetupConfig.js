...
function rebuildSysConfigFromSource() {
    ...
    try {
        ...
        console.log('Starting row-by-row validation...');
        for (let i = 0; i < masterConfig.length; i++) {
            if (masterConfig[i].length !== 13) {
                console.error(`Row ${i} has an incorrect column count. Expected 13, but got ${masterConfig[i].length}.`);
                console.error(`Problematic row content: ${JSON.stringify(masterConfig[i])}`);
            }
        }
        console.log('Row-by-row validation complete.');
 ...
 * @returns {Array<Array<string>>} A 2D array representing the System config data.
 */
function _getSystemConfig() {
    return [
        ...
        ['system.sheet_names', 'Names of the sheets in the spreadsheets', 'stable', 'SysProductAudit', 'SysProductAudit', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Names of the sheets in the spreadsheets', 'stable', 'SysFileRegistry', 'SysFileRegistry', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Names of the sheets in the spreadsheets', 'stable', 'CmxProdM', 'CmxProdM', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Names of the sheets in the spreadsheets', 'stable', 'CmxProdS', 'CmxProdS', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Names of the sheets in the spreadsheets', 'stable', 'WebProdS_EN', 'WebProdS_EN', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Names of the sheets in the spreadsheets', 'stable', 'WebProdM', 'WebProdM', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Names of the sheets in the spreadsheets', 'stable', 'WebXltS', 'WebXltS', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Names of the sheets in the spreadsheets', 'stable', 'WebXltM', 'WebXltM', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Names of the sheets in the spreadsheets', 'stable', 'SysPackingCache', 'SysPackingCache', '', '', '', '', '', '', '', ''],
...
function _getMapComaxProductColumnsConfig() {
    return [
...
function _getMapStagingToMasterWebOrdersConfig() {
    return [
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_OrderId', 'wom_OrderId', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_OrderNumber', 'wom_OrderNumber', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_OrderDate', 'wom_OrderDate', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_Status', 'wom_Status', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_CustomerNote', 'wom_CustomerNote', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_BillingFirstName', 'wom_BillingFirstName', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_BillingLastName', 'wom_BillingLastName', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_BillingEmail', 'wom_BillingEmail', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_BillingPhone', 'wom_BillingPhone', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_ShippingFirstName', 'wom_ShippingFirstName', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_ShippingLastName', 'wom_ShippingLastName', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_ShippingAddress1', 'wom_ShippingAddress1', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_ShippingAddress2', 'wom_ShippingAddress2', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_ShippingCity', 'wom_ShippingCity', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_orders', 'Maps WebOrdS staging columns to WebOrdM master columns.', 'stable', 'wos_ShippingPhone', 'wom_ShippingPhone', '', '', '', '', '', '', '', ''],
    ];
}

function _getMapStagingToMasterWebProductsConfig() {
    return [
        ['map.staging_to_master.web_products', 'Maps WebProdS_EN staging columns to WebProdM master columns.', 'stable', 'wps_Stock', 'wpm_Stock', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_products', 'Maps WebProdS_EN staging columns to WebProdM master columns.', 'stable', 'wps_RegularPrice', 'wpm_Price', '', '', '', '', '', '', '', ''],
        ['map.staging_to_master.web_products', 'Maps WebProdS_EN staging columns to WebProdM master columns.', 'stable', 'wps_Published', 'wpm_PublishStatusEn', '', '', '', '', '', '', '', ''],
    ];
}

function _getMapWebProductColumnsConfig() {
    return [
...
function _getMapWebOrderColumnsConfig() {
    return [
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'order_id', 'wos_OrderId', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'order_number', 'wos_OrderNumber', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'order_date', 'wos_OrderDate', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'paid_date', 'wos_PaidDate', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'status', 'wos_Status', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_total', 'wos_ShippingTotal', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_tax_total', 'wos_ShippingTaxTotal', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'fee_total', 'wos_FeeTotal', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'fee_tax_total', 'wos_FeeTaxTotal', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'tax_total', 'wos_TaxTotal', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'cart_discount', 'wos_CartDiscount', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'order_discount', 'wos_OrderDiscount', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'discount_total', 'wos_DiscountTotal', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'order_total', 'wos_OrderTotal', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'order_subtotal', 'wos_OrderSubtotal', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'order_currency', 'wos_OrderCurrency', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'payment_method', 'wos_PaymentMethod', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'payment_method_title', 'wos_PaymentMethodTitle', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'transaction_id', 'wos_TransactionId', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'customer_ip_address', 'wos_CustomerIpAddress', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'customer_user_agent', 'wos_CustomerUserAgent', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_method', 'wos_ShippingMethod', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'customer_id', 'wos_CustomerId', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'customer_user', 'wos_CustomerUser', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'customer_email', 'wos_CustomerEmail', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'billing_first_name', 'wos_BillingFirstName', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'billing_last_name', 'wos_BillingLastName', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'billing_company', 'wos_BillingCompany', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'billing_email', 'wos_BillingEmail', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'billing_phone', 'wos_BillingPhone', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'billing_address_1', 'wos_BillingAddress1', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'billing_address_2', 'wos_BillingAddress2', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'billing_postcode', 'wos_BillingPostcode', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'billing_city', 'wos_BillingCity', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'billing_state', 'wos_BillingState', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'billing_country', 'wos_BillingCountry', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_first_name', 'wos_ShippingFirstName', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_last_name', 'wos_ShippingLastName', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_company', 'wos_ShippingCompany', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_phone', 'wos_ShippingPhone', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_address_1', 'wos_ShippingAddress1', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_address_2', 'wos_ShippingAddress2', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_postcode', 'wos_ShippingPostcode', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_city', 'wos_ShippingCity', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_state', 'wos_ShippingState', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_country', 'wos_ShippingCountry', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'customer_note', 'wos_CustomerNote', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'wt_import_key', 'wos_WtImportKey', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'shipping_items', 'wos_ShippingItems', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'fee_items', 'wos_FeeItems', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'tax_items', 'wos_TaxItems', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'coupon_items', 'wos_CouponItems', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'refund_items', 'wos_RefundItems', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'order_notes', 'wos_OrderNotes', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'download_permissions', 'wos_DownloadPermissions', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'meta:wpml_language', 'wos_MetaWpmlLanguage', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_1', 'wos_LineItem1', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_2', 'wos_LineItem2', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_3', 'wos_LineItem3', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_4', 'wos_LineItem4', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_5', 'wos_LineItem5', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_6', 'wos_LineItem6', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_7', 'wos_LineItem7', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_8', 'wos_LineItem8', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_9', 'wos_LineItem9', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_10', 'wos_LineItem10', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_11', 'wos_LineItem11', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_12', 'wos_LineItem12', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_13', 'wos_LineItem13', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_14', 'wos_LineItem14', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_15', 'wos_LineItem15', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_16', 'wos_LineItem16', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_17', 'wos_LineItem17', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_18', 'wos_LineItem18', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_19', 'wos_LineItem19', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_20', 'wos_LineItem20', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_21', 'wos_LineItem21', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_22', 'wos_LineItem22', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_23', 'wos_LineItem23', '', '', '', '', '', '', '', ''],
        ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_24', 'wos_LineItem24', '', '', '', '', '', '', '', ''],
    ];
}



function _getMapWebTranslationColumnsConfig() {
    return [
...
function _getWebOrderLineItemSchemaConfig() {
    return [
        ['web.order.line_item_schema', 'Defines the schema for WooCommerce order line items.', 'stable', 'line_item_prefix', 'wos_LineItem', '', '', '', '', '', '', '', ''],
        ['web.order.line_item_schema', 'Defines the schema for WooCommerce order line items.', 'stable', 'product_item_prefix', 'wos_Product_Item_', '', '', '', '', '', '', '', ''],
        ['web.order.line_item_schema', 'Defines the schema for WooCommerce order line items.', 'stable', 'max_line_items', '24', '', '', '', '', '', '', '', ''],
        ['web.order.line_item_schema', 'Defines the schema for WooCommerce order line items.', 'stable', 'product_item_fields', 'Name,id,SKU,Quantity,Total,Subtotal', '', '', '', '', '', '', '', ''],
    ];
}

function _getMappingsConfig() {
    return [
        // Mappings
        ['_section.04_Mappings', 'Header and value mappings for data transformation.', '', '', '', '', '', '', '', '', '', '', ''],
        ..._getMapComaxProductColumnsConfig(),
        ..._getMapStagingToMasterWebOrdersConfig(),
        ..._getMapStagingToMasterWebProductsConfig(),
        ..._getMapWebProductColumnsConfig(),
        ..._getMapWebOrderColumnsConfig(),
        ..._getMapWebTranslationColumnsConfig(),
        ..._getWebOrderLineItemSchemaConfig(),
    ];
}

function _getValidationDataSourceIntegrityConfig() {
    return [
...
function _getValidationStagingMasterReconciliationConfig() {
    return [
...
function _getValidationCrossSystemReconciliationConfig() {
    return [
...
function _getValidationConfig() {
    return [
        ...
        ..._getValidationDataSourceIntegrityConfig(),
        ..._getValidationStagingMasterReconciliationConfig(),
        ..._getValidationCrossSystemReconciliationConfig(),
    ];
}

function _getNewMappingsConfig() {
    return [
        // New Mappings for Coded Values (Sheet-based)
        ['map.grape_codes', 'Pointer to the grape codes lookup sheet.', 'stable', 'sheet_name', 'SysLkp_Grapes', 'key_col', 'slg_Code', 'val_col_en', 'slg_TextEN', 'val_col_he', 'slg_TextHE', '', ''],
        ['map.kashrut_codes', 'Pointer to the kashrut codes lookup sheet.', 'stable', 'sheet_name', 'SysLkp_Kashrut', 'key_col', 'slk_Code', 'val_col_en', 'slk_TextEN', 'val_col_he', 'slk_TextHE', '', ''],
        ['map.boolean_codes', 'Pointer to the boolean text lookup sheet.', 'stable', 'sheet_name', 'SysLkp_Texts', 'key_col', 'slt_Code', 'val_col_en', 'slt_TextEN', 'val_col_he', 'slt_TextHE', '', ''],
        ['map.pairing_codes', 'Pointer to the pairing text lookup sheet.', 'stable', 'sheet_name', 'SysLkp_Texts', 'key_col', 'slt_Code', 'val_col_en', 'slt_TextEN', 'val_col_he', 'slt_TextHE', '', ''],
    ];
}

function _getPairingKeysConfig() {
    return [
...
function _getMigrationSyncTasksConfig() {
    return [
...
function _getMigrationColumnMappingConfig() {
    return [
...
function _getOtherSettingsConfig() {
    return [
        // Other
...
function _getTaskDefinitionsConfig() {
    return [
...
function getMasterConfiguration() {
    return [
        ...
        // Task Definitions
        ..._getTaskDefinitionsConfig(),

        // Keys for Conditional Lookups in SysLkp_Texts
        ..._getMigrationColumnMappingConfig(),
