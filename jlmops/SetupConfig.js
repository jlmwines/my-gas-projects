...
function getMasterConfiguration() {
    return [
        ...
        ['schema.data.SysOrdLog', 'Schema for System Order Log sheet.', 'stable', 'headers', 'sol_OrderId,sol_OrderDate,sol_PackingStatus,sol_PackingPrintedTimestamp,sol_ComaxExportStatus,sol_ComaxExportTimestamp', '', '', '', '', '', '', '', ''],
        ...
        ['map.web.product_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'Stock', 'wps_Stock', '', '', '', '', '', '', '', ''],
                ...
                ['map.web.order_columns', 'Maps WooCommerce CSV headers to internal field names for staging.', 'stable', 'line_item_23', 'wos_LineItem23', '', '', '', '', '', '', '', ''],
                        ...
                        ['web.order.line_item_schema', 'Defines the schema for WooCommerce order line items.', 'stable', 'product_item_fields', 'Name,id,SKU,Quantity,Total,Subtotal', '', '', '', '', '', '', '', ''],
                                ...
                                ['map.web.translation_columns', 'Maps wehe.csv headers to internal field names for staging.', 'stable', 'id', 'wxs_WebIdHe', '', '', '', '', '', '', '', ''],        ['map.web.translation_columns', 'Maps wehe.csv headers to internal field names for staging.', 'stable', 'post_title', 'wxs_NameHe', '', '', '', '', '', '', '', ''],
        ...
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'WebOrdM', 'WebOrdM', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'WebOrdItemsM', 'WebOrdItemsM', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'WebOrdS', 'WebOrdS', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'SysOrdLog', 'SysOrdLog', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'WebProdM', 'WebProdM', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'WebProdS_EN', 'WebProdS_EN', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'CmxProdS', 'CmxProdS', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'CmxProdM', 'CmxProdM', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'WebDetM', 'WebDetM', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'WebXltM', 'WebXltM', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'WebXltS', 'WebXltS', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'SysInventoryOnHold', 'SysInventoryOnHold', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'SysPackingCache', 'SysPackingCache', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'OrderLogArchive', 'OrderLogArchive', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'WebOrdM_Archive', 'WebOrdM_Archive', '', '', '', '', '', '', '', ''],
        ['system.sheet_names', 'Canonical names for all system-managed sheets.', 'stable', 'WebOrdItemsM_Archive', 'WebOrdItemsM_Archive', '', '', '', '', '', '', '', ''],
